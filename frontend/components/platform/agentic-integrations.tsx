...
type RecordPreview={id:string;conversation_id:string;transcript:string;asset_tag:string[];defect:string[];recommended_action:string[];status:string;indexing:string;timestamp:string|null;provider:string};
